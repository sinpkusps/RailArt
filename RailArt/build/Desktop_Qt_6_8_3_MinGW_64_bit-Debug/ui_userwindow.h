...
""));
        ...
        menubar->setGeometry(QRect(0, 0, 1344, 18));
    ...
    void retranslateUi(QMainWindow *UserWindow)
    {
        ...
        pushButto_create->setText(QCoreApplication::translate("UserWindow", "\347\224\237\346\210\220\350\275\246\347\245\250", nullptr));
