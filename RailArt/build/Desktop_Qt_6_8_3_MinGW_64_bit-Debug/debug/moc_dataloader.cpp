...
#include "../../../../../Qt projects/Died_RailArt/dataloader.h"
...
static constexpr auto qt_meta_stringdata_ZN10dataloaderE = QtMocHelpers::stringData(
    "dataloader"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10dataloaderE[] = {
...
Q_CONSTINIT const QMetaObject dataloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10dataloaderE.offsetsAndSizes,
    qt_meta_data_ZN10dataloaderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10dataloaderE_t,
        // Q_OBJECT / Q_GADGET
...
void *dataloader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10dataloaderE.stringdata0))
