...
static constexpr auto qt_meta_stringdata_ZN10UserDialogE = QtMocHelpers::stringData(
    "UserDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10UserDialogE[] = {
...
Q_CONSTINIT const QMetaObject UserDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10UserDialogE.offsetsAndSizes,
    qt_meta_data_ZN10UserDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10UserDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UserDialog, std::true_type>,
        // method 'on_pushButtonRecharge_clicked'
...
void UserDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushButtonRecharge_clicked(); break;
...
void *UserDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10UserDialogE.stringdata0))
