...
struct qt_meta_stringdata_CLASSInvitationDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInvitationDialogENDCLASS = QtMocHelpers::stringData(
    "InvitationDialog",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSInvitationDialogENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSInvitationDialogENDCLASS_t qt_meta_stringdata_CLASSInvitationDialogENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16),  // "InvitationDialog"
        QT_MOC_LITERAL(17, 27),  // "on_pushButtonCommit_clicked"
        QT_MOC_LITERAL(45, 0),  // ""
        QT_MOC_LITERAL(46, 28),  // "on_pushButtonMessage_clicked"
        QT_MOC_LITERAL(75, 27),  // "on_tabWidget_currentChanged"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInvitationDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InvitationDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInvitationDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInvitationDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInvitationDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *InvitationDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInvitationDialogENDCLASS.stringdata0))
